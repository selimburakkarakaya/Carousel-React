...
function App() {
  ...
  return (
    <div className="max-w-full w-full h-screen flex justify-center items-center px-16 relative bg-violet-500">
      <div style={{ backgroundImage: `url(${imageData[index].image})` }} className="w-[768px] h-[512px] rounded-2xl bg-center bg-cover duration-500 shadow-2xl"></div>
